...
import { allure, step } from "allure-js-commons";
...
// === WHEN ===
When('user performs "delete" a "basic group" operation with parameters {string} and {string}', async function (identityDescription, identityCode) {
